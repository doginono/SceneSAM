...
def create_complete_mapping(curr_frame_number, frame_numbers, T,K, depths, frames, segmentations, id_counter, points_per_instance=5):
    ...
    Args:
        ...
        depths (list): contains all depths of the frames
        frames (list): contains all rgb images
        segmentations (list): contains all segmentations of (seen/all; depending on implementation) frames
    ...
    depthf = depths[curr_frame_number]
