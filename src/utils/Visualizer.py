    ...
    def vis(
        ...
        if (
            ...
            with torch.no_grad():
                ...
                depth, uncertainty, color, semantic = (
                    self.renderer.render_img(  # Done add semantics
                        c,
                        decoders,
                        c2w,
                        self.device,
                ...
                print("Shape of rendered color", color.shape)
                ...
                predicted_semantic_probs = semantic_np[
                    np.arange(semantic_np.shape[0])[:, None],
