...
class NICE_SLAM:
    ...
    def __init__(self, cfg, args):
        ...
        self.frame_reader = get_dataset(
            cfg, args, self.scale, slam=self
        )  # J:saves ordered the paths of images, depth masks
        ...
        # those are the mapping indeces by nice-slam
        ...
        for (
            ...
            self.shared_c.items()
        ):  # J:shared_c contains the grids for the different decoders
        ...
        self.vis_renderer = Renderer(
            cfg, args, self, points_batch_size=100000, ray_batch_size=10000
        )
        ...
        self.tracker = Tracker(
            cfg, args, self
        )  # TODO, returns will be different -> small changes in Tracker function, not in initialization
    ...
    def grid_init(self, cfg):
        ...
        semantic_val_shape[0], semantic_val_shape[2] = (
            semantic_val_shape[2],
            semantic_val_shape[0],
        )
