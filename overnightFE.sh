...
start_time=$(date +%s)
python -W ignore run.py configs/Scannet++/fe1733741f.yaml
#!/bin/bash
...
commands=(["command1"]="python -W ignore run.py configs/Scannet++/fe1733741f.yaml")
commands=(["command2"]="python -W ignore run.py configs/Scannet++/8b5caf3398.yaml")
